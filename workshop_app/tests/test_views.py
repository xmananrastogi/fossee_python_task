...
class TestProfile(TestCase):
    def setUp(self):
        ...
        self.user1 = User.objects.create(
            username="demo_test_user1", password="pass@123", email="test.user@gmail.com"
        )

        self.user2 = User.objects.create(
            username="demo_test_user2", email="test.user@gmail.com"
        )
...
class TestWorkshopCreation(TestCase):
    def setUp(self):
        ...
        self.superuser = User.objects.create_superuser(
            username="admin", password="pass@123", email="test.user@gmail.com"
        )

        self.mod_group = Group.objects.create(name="instructor")

        self.user_one = User.objects.create(
            username="test_user1", email="test.user@gmail.com"
        )
        ...
        self.user_two = User.objects.create(
            username="demo_user2", email="test.user@gmail.com"
        )
        ...
        self.workshoptype = WorkshopType.objects.create(
            workshoptype_name="ISCP",
            workshoptype_description="Introduction to Scientific Computing in Python <br>\
				> Numpy <br> > Matplotlib <br> > iPython <br>",
    ...
    def test_create_workshoptype_superuser(self):
        ...
        self.client.post(
            ("/admin/workshop_app/workshoptype/add/"),
            data={
        ...
        self.workshoptype_one = WorkshopType.objects.get(
            workshoptype_name="Basic Python"
        )
        self.assertEqual(self.workshoptype_one.workshoptype_name, "Basic Python")
        self.assertEqual(
            self.workshoptype_one.workshoptype_duration, "3days, 8hours a day"
        )
        self.client.logout()
    ...
    def test_propose_workshop_coordinator(self):
        ...
        self.proposed_workshop = ProposeWorkshopDate.objects.get(
            proposed_workshop_date="2017-06-06"
        )
        self.assertEqual(
            str(self.proposed_workshop.proposed_workshop_title),
...
class TestWorkshopDashboard(TestCase):
    def setUp(self):
        ...
        self.workshop = Workshop.objects.create(
            workshop_instructor=self.user_one,
...
class TestWorkshopStats(TestCase):
    ...
    def test_workshop_stats(self):
        ...
        response = self.client.post(
            "/workshop_stats/",
            {"from": "2017-01-01", "to": "2017-12-31", "Download": "download"},
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
